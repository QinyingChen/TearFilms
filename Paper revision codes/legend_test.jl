...
plot(t1,h,xlabel=L"t",ylabel=L"h",title="",label=false,lw = 2,ls=:solid)
plot!(t2,h2,label=false,lw = 2,ls=:dash)
plot!(t3,h3,label=false,lw = 2,ls=:dot)
A = plot!(t4,h4,label=false,lw = 2,guidefontsize=15,legendfontsize=10,ls=:dashdot)

plot(t1,c,xlabel=L"t",ylabel=L"c",title="",label=false,lw = 2,ls=:solid)
plot!(t2,c2,label=false,lw = 2,ls=:dash)
plot!(t3,c3,label=false,lw = 2,ls=:dot)
B = plot!(t4,c4,label=false,lw = 2,guidefontsize=15,ls=:dashdot)

plot(t1,f,xlabel=L"t",ylabel=L"f",title="",label=false,lw = 2,ls=:solid)
plot!(t2,f2,label=false,lw = 2,ls=:dash)
plot!(t3,f3,label=false,lw = 2,ls=:dot)
C = plot!(t4,f4,label=false,lw = 2,guidefontsize=15,ls=:dashdot)
...
D = plot!(t4,I4,label="streak",lw = 2,legendfontsize=9,guidefontsize=15,ls=:dashdot)
...
Q1=plot(A,B,C,D; layout, size = (550,550),legendfontsize=5)
...
plot(t1,h,xlabel=L"t",ylabel=L"h",title="",label=false,lw = 2,ls=:solid)
plot!(t2,h2,label=false,lw = 2,ls=:dash)
AA = plot!(t3,h3,label=false,lw = 2,guidefontsize=15,ls=:dot)


plot(t1,c,xlabel=L"t",ylabel=L"c",title="",label=false,lw = 2,ls=:solid)
plot!(t2,c2,label=false,lw = 2,ls=:dash)
BB = plot!(t3,c3,label=false,lw = 2,guidefontsize=15,ls=:dot)


plot(t1,f,xlabel=L"t",ylabel=L"f",title="",label=false,lw = 2,ls=:solid)
plot!(t2,f2,label=false,lw = 2,ls=:dash)
CC = plot!(t3,f3,label=false,lw = 2,guidefontsize=15,ls=:dot)


plot(t1,I1,xlabel=L"t",ylabel=L"I",title="",label=L"x_k=1.5",lw = 2,ls=:solid)
plot!(t2,I2,label=L"x_k=0.8",lw = 2,ls=:dash)
DD = plot!(t3,I3,label=L"x_k=0.6",legendfontsize=13,guidefontsize=15,lw = 2,ls=:dot)

layout = @layout [a b;c d;e f; g h ]
Q2=plot(A,AA,B,BB,C,CC,D,DD; layout,size = (550, 600),legendfontsize=5)